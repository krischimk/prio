...
export const LIST_ICONS_MDI: ListIconDefinition[] = [
  ...
  },
  {
    id: 'std:food',
    label: 'Essen',
    source: 'mdi/silverware-fork-knife',
    filled: true,
    paths: [
  ...
  },
  {
    id: 'std:flag',
    label: 'Merken',
    source: 'mdi/flag-outline',
    filled: true,
    paths: [
      'M12.36,6L12.76,8H18V14H14.64L14.24,12H7V6H12.36M14,4H5V21H7V14H12.6L13,16H20V6H14.4',
    ],
  },
  {
    id: 'std:japan',
